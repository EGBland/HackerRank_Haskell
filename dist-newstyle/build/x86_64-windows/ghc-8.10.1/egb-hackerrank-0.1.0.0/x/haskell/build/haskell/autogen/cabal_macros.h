...
/* package egb-hackerrank-0.1.0.0 */
#ifndef VERSION_egb_hackerrank
#define VERSION_egb_hackerrank "0.1.0.0"
#endif /* VERSION_egb_hackerrank */
#ifndef MIN_VERSION_egb_hackerrank
#define MIN_VERSION_egb_hackerrank(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_egb_hackerrank */
...
#define CURRENT_COMPONENT_ID "egb-hackerrank-0.1.0.0-inplace-haskell"
